...
namespace GameProject
{
    partial class Program
    {
        ...
        {
            //Kullanıcı
            User user1 = new User() { Id = 1, FirstName = "Betül", LastName = "Geçer", DateOfBirth = new DateTime(1998, 06, 13), NationalityId = "42517863259" };
            User user2 = new User() { Id = 2, FirstName = "Selim", LastName = "Bakır", DateOfBirth = new DateTime(1997, 08, 30), NationalityId = "75694236158" };
